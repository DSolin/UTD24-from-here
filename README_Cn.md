 ...
 **UTD24作为经管领域的顶级期刊列表，记录了经济和管理领域最伟大、最前沿的学术成果，奠定了整个经管学术大厦的基座。但是平时在阅读的时候穿梭在各个期刊检索页面非常繁琐，为了方便大家更好地探索、吸收这24本学术期刊中的最新成果，UTD24-from-here可以一键搜集24本期刊的数据，并将原始文献转化为交互式可视化仪表板：作者分布图、关键词词云、发表趋势图、作者合作网络，一应俱全，方便学习者通过文献数据可视化获得思考。**
